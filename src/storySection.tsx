...
const STORY_DATA: Story[] = [
  {
    ...
    description: 'There are moments in every startup when you realize your tech is too smart for its own good. For us, that moment came when our AI tried to speak Tamil...',
  ...
  },
  {
    ...
    description: 'For years, dubbing was trapped in post-production. But now, real-time dubbing is rewriting the rules – and India is at the forefront of this revolution.',
  ...
  },
  {
    ...
    description: 'Voice tech has long chased perfection—clarity, pronunciation, zero noise. But somewhere along the way, we forgot what really matters: feeling.',
  ...
  return (
    <div className="flex flex-col bg-black text-white rounded-lg h-full relative group">
      ...
      <div className="aspect-video w-full bg-gray-900 overflow-hidden rounded-t-lg">
        <img
          ...
          onError={(e) => {
            ...
            e.currentTarget.src = "https://placehold.co/400x300/111827/ffffff?text=Image+Missing";
          }}
        />
      </div>
      ...
      <div className="px-5 pb-5 pt-4 flex flex-col flex-grow">
        ...
        <a 
          href={readMoreUrl} 
          className="text-white text-sm font-medium flex items-center transition-colors hover:text-indigo-400 w-fit"
