...
export const cards: Card[] = [
  {
    ...
    text: "Before Vācaka.AI I spent most of my week in studios re-recording the same lines for different languages. Now, their Dubb™ engine does the heavy lifting...",
    color: "#7B4FFF",
  ...
  },
  {
    ...
    text: "Generic AI costs are a mirage. We were spending 50% of the savings on manual QA to fix pacing, lip sync, and emotional tone...",
    color: "#5F8BFF",
  ...
  },
  {
    ...
    text: "We were told live dubbing was science fiction. Vācaka.AI’s Streaming Inference let us go live with regional broadcasts in five languages...",
    color: "#C45F8C",
    img: Images.AASTHA,
  },
  {
    id: 4,
    name: "Rohit Vistaplay",
    role: "ASSOCIATE VP – NDTV",
    text: "We were told live dubbing was science fiction. Vācaka.AI’s Streaming Inference let us go live with regional broadcasts in five languages...",
    color: "#C45F8C",
